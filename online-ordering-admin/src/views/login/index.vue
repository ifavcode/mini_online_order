      ...
      useUserStoreHook()
        ...
        .then(res => {
          if (res.success) {
            ...
            initRouter().then(() => {
              disabled.value = true;
              const to: any = route.query.back || getTopMenu(true).path
              router
                .push(to)
                .then(() => {
...
async function getDemoModeFunc() {
      ...
      <div class="login-box">
        <div class="login-form">
          ...
          <el-form ref="ruleFormRef" :model="ruleForm" :rules="loginRules" size="large">
            ...
            <Motion v-if="demoMode">
              <div class="text-red-400 text-sm text-left">演示模式，保存数据不会生效！！！</div>
            </Motion>
